define(function() {
     ...
     * slowing calls down.
     */
    var probe_super = (function(){_super();}).toString().indexOf('_super') > 0;
    function usesSuper(obj) {
        return true || /\B\_super\b/.test(obj.toString());
    };
    ...
    Class.extend = function(properties) {
        ...
        for (var name in properties) {
            ...
            prototype[name] = typeof value === 'function' && usesSuper(value) 
                ? (function(meth, name) {
                    return function() {
                        var old_super = getOwnProperty(this, '_super');
                        this._super = super_prototype[name];
                        try {
                            return meth.apply(this, arguments);
                        } finally {
                            setOrUnset(this, '_super', old_super);
                        }
                    }})(value, name) 
                : value
            ;    
        ...
        // dummy constructor
        var class_proto = function() {
            if (disable_constructor) {
                return;
            }
            var proper_this = context === this ? cheapNew(arguments.callee) : this;
            if (proper_this.init) {
                proper_this.init.apply(proper_this, arguments);
            }
            proper_this.class = class_proto;
            return proper_this;
        }
         ...
         * return the class
         */
        class_proto.prototype = prototype;
        class_proto.constructor = class_proto;
        class_proto.extend = Class.extend;
